        ...
        <>
            <div className='container mx-auto mt-8'>
                <div className="grid grid-cols-1 sm:grid sm:grid-cols-2 gap-2">
                    <div>
                        <div className='px-8 sm:px-20 sm:py-20'>
                            <p className='text-2xl sm:text-6xl font-bold leading-normal text-slate-800'> Branding that <br />
                                <span className="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-green-500 relative inline-block"> <span className="relative text-white"> inspires </span> </span>
                            </p>
                    ...
                    <div>
                        <div>
                            <img className='hidden sm:visible sm:px-10 sm:py-10 sm:ml-16' src={slider} alt="HighlightedContent" />
                        </div>
                        <SocialLink />
                    </div>
                </div>
